...
const tldWrite = () => (
  <div className="tld13Container sectionMargin" id="tldWrite">
    <div className="tld13Feature">
      ...
      That's why SayIt created a smart solution for Automated Meeting Minutes, converting conversations into actions, empowering your skills, and saving hours of your time."
      />
    </div>
    ...
    <div className="tld13FeatureContainer">
      ...
      <Feature
        ...
        text="SayIt transcribes your conversations on the fly. SayIt will generate a transcript enriched with speaker identification and voice separation."
      />
    </div>
  </div>
);
