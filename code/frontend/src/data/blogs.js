export const blogs = [
  {
    ...
    full_text: [
          {
            title: '',
            paragraph:  "In the rapidly advancing world of technology, Natural Language Processing (NLP) stands out as a revolutionary force, transforming the way we communicate, learn, and work. This cutting-edge branch of artificial intelligence empowers machines to understand, interpret, and generate human language, bringing about a paradigm shift in various industries.",
      },
      {
