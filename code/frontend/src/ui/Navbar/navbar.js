...
import logo from '../../utils/assets/logo_4.png';
...
const Menu = () =>{
  return (
    ...
    <p className="hover-underline-animation"><a href="#SayIt">What is SayIt?</a></p>
    ...
    <p className="hover-underline-animation"><a href="#speechToText">Download Extension</a></p>
